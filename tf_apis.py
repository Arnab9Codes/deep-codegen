...
def mat_dot(input1, input2, dim1_0, dim1_1, device0):
    @tf.custom_gradient
    def _lambda(X1, X2):
        return mat_dot_real(X1, X2, dim1_0, dim1_1, device0)
    return _lambda(input1, input2)

def mat_dot_real(input1, input2, dim1_0, dim1_1, device0):
    out = gp_apis.gp_mat_dot(input1, input2, dim1_0, dim1_1, device0)
    def grad(dZ1, dZ2):
        return gp_apis.gp_mat_dot(dZ1, dZ2, dim1_0, dim1_1, device0)
    return out, grad

def mat_transpose(input1, dim1_0, dim1_1, device0):
    @tf.custom_gradient
    def _lambda(X1):
        return mat_transpose_real(X1, dim1_0, dim1_1, device0)
    return _lambda(input1)

def mat_transpose_real(input1, dim1_0, dim1_1, device0):
    out = gp_apis.gp_mat_transpose(input1, dim1_0, dim1_1, device0)
    def grad(dZ1):
        return gp_apis.gp_mat_transpose(dZ1, dim1_0, dim1_1, device0)
    return out, grad

def mat_add(input1, input2, dim1_0, dim1_1, device0):
    @tf.custom_gradient
    def _lambda(X1, X2):
        return mat_add_real(X1, X2, dim1_0, dim1_1, device0)
    return _lambda(input1, input2)

def mat_add_real(input1, input2, dim1_0, dim1_1, device0):
    out = gp_apis.gp_mat_add(input1, input2, dim1_0, dim1_1, device0)
    def grad(dZ1, dZ2):
        return gp_apis.gp_mat_add(dZ1, dZ2, dim1_0, dim1_1, device0)
    return out, grad

def mat_mul(input1, input2, dim1_0, dim1_1, device0):
    @tf.custom_gradient
    def _lambda(X1, X2):
        return mat_mul_real(X1, X2, dim1_0, dim1_1, device0)
    return _lambda(input1, input2)

def mat_mul_real(input1, input2, dim1_0, dim1_1, device0):
    out = gp_apis.gp_mat_mul(input1, input2, dim1_0, dim1_1, device0)
    def grad(dZ1, dZ2):
        return gp_apis.gp_mat_mul(dZ1, dZ2, dim1_0, dim1_1, device0)
    return out, grad

def mat_norm(input1, device0):
    @tf.custom_gradient
    def _lambda(X1):
        return mat_norm_real(X1, device0)
    return _lambda(input1)

def mat_norm_real(input1, device0):
    out = gp_apis.gp_mat_norm(input1, device0)
    def grad(dZ1):
        return gp_apis.gp_mat_norm(dZ1, device0)
    return out, grad
