inline void export_kernel(py::module &m) { 
    ...
    m.def("mat_dot",[](py::capsule& input1, py::capsule& input2, py::capsule& output1, int M, int P, int N){
        array2d_t<float> input1_array = capsule_to_array2d(input1);
        array2d_t<float> input2_array = capsule_to_array2d(input2);
        array2d_t<float> output1_array = capsule_to_array2d(output1);
    return mat_dot(input1_array, input2_array, output1_array, M, P, N);
    }
  );
    m.def("mat_transpose",[](py::capsule& input1, py::capsule& output1, int M, int N){
        array2d_t<float> input1_array = capsule_to_array2d(input1);
        array2d_t<float> output1_array = capsule_to_array2d(output1);
    return mat_transpose(input1_array, output1_array, M, N);
    }
  );
    m.def("mat_add",[](py::capsule& input1, py::capsule& input2, py::capsule& output1, int M, int N){
        array2d_t<float> input1_array = capsule_to_array2d(input1);
        array2d_t<float> input2_array = capsule_to_array2d(input2);
        array2d_t<float> output1_array = capsule_to_array2d(output1);
    return mat_add(input1_array, input2_array, output1_array, M, N);
    }
  );
    m.def("mat_mul",[](py::capsule& input1, py::capsule& input2, py::capsule& output1, int M, int N){
        array2d_t<float> input1_array = capsule_to_array2d(input1);
        array2d_t<float> input2_array = capsule_to_array2d(input2);
        array2d_t<float> output1_array = capsule_to_array2d(output1);
    return mat_mul(input1_array, input2_array, output1_array, M, N);
    }
  );
    m.def("mat_norm",[](py::capsule& input1, int M, int N){
        array2d_t<float> input1_array = capsule_to_array2d(input1);
    return mat_norm(input1_array, M, N);
    }
  );
}